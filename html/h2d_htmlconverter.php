      ...
      case 'img':
        ...
        if (strpos($element_src, 'http://') === 0) {
          ...
          // appear in the Word document.
            $path = realpath(Yii::app()->getBasePath() . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . 'img') . DIRECTORY_SEPARATOR;
            $name = $path.uniqid().".jpg";
            download_image($element_src, $name);  
            $src = $element_src = $name;
        }
