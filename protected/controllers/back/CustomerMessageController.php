...
// $this->performAjaxValidation($model);
        ...
        if (isset($_POST['CustomerMessage'])) {
            ...
            if ($model->save())
                $this->redirect(array('view', 'id' => $model->id_customer_message));
        }
...
// if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('CustomerMessage');
    ...
    public function actionAdmin() {
        $model = new CustomerMessage('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['CustomerMessage']))
            $model->attributes = $_GET['CustomerMessage'];
