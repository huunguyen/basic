...
class Project extends TrackStarActiveRecord
{
    ...
    protected function afterSave()
    {
        parent::afterSave();
        if($this->isNewRecord){
            //$this->associateUserToProject(User::model()->findByPk($this->create_user_id));
        }
        else
        {
            //$this->associateUserToProject($this->create_user_id);
        }
    ...
    */
	...
	public function associateUserToProject($user)
	{
        ...
        $command->bindValue(":role",'Creator Project',PDO::PARAM_INT);
		return $command->execute();    
	} 
