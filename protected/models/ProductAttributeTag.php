...
/**
 * This is the model class for table "tbl_product_attribute_tag".
 *
 * The followings are the available columns in table 'tbl_product_attribute_tag':
 ...
 */
class ProductAttributeTag extends CActiveRecord
{
	/**
	...
	{
		return 'tbl_product_attribute_tag';
	}
	...
	public function rules()
	{
		...
		return array(
			array('id_product, id_product_attribute, id_tag', 'required'),
			array('id_product, id_product_attribute, id_tag, frequency', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_product, id_product_attribute, id_tag, frequency', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ProductAttributeTag the static model class
	 */
    ...
    public function updateRecord() {
        $model = self::model()->findByPk(array('id_product' => $this->id_product, 'id_product_attribute'=> $this->id_product_attribute, 'id_tag' => $this->id_tag));
