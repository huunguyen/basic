...
class LoginForm extends CFormModel {
	...
	public function rules() {
		return array(
			array('username, passwd, email', 'required'),
			array('username', 'length', 'max' => 45),
			array('passwd', 'length', 'max' => 50, 'min' => 6),
	...
	public function authenticate($attribute, $params) {
		if (!$this->hasErrors()) {
			...
			if (!$this->_identity->authenticate()) {
				...
				$this->addError('username', Yii::t('errors', 'Incorrect username and/or passwd.'));
				$this->addError('passwd', Yii::t('errors', 'Incorrect username and/or passwd.'));
			}
		}
	}
