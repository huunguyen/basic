...
<div class="widget">
    ...
    $this->widget('bootstrap.widgets.TbGridView', array(
        ...
        'summaryText' => 'Tất cả Phường xã. Hiển thị từ {start}-{end} của {count} kết quả.',
        'columns' => array(
            array('name' => 'id_ward', 'header' => 'MV-KV'),
            array('name' => 'name', 'header' => 'Tên Vùng | Khu Vực'),
            array('name' => 'idDistrict.name', 'header' => 'Tên Quận | Huyện'),
            ...
            array(
                    ...
                    'buttons' => array
                        ...
                        'show' => array
                            ...
                            'label' => 'Xem chi tiết',
                            'icon' => 'icon-eye-open',
                            'url' => 'Yii::app()->createUrl("zone/viewWard", array("id"=>$data["id_ward"]))',
                            'options' => array(
                                'class' => 'view',
                            ),
                        ),
                        'modify' => array
                            ...
                            'label' => 'Cập nhật',
                            'icon' => 'icon-document',
                            'url' => 'Yii::app()->createUrl("zone/updateWard", array("id"=>$data["id_ward"]))',
                            'options' => array(
                                'class' => 'view',
                            ),
                            'encodeLabel' => false,
                        ...
                        'del' => array(
                            'label' => 'Xóa',
                            'icon' => 'icon-trash',
                            'url' => 'Yii::app()->createUrl("zone/deleteWard", array("id"=>$data["id_ward"]))',
                            'click' => "function() {
...
<?php $this->widget('bootstrap.widgets.TbButton', array(
 ...
 <?php $this->widget('bootstrap.widgets.TbButton', array(
    ...
    'type'=>'primary', // null, 'primary', 'info', 'success', 'warning', 'danger' or 'inverse'
    'size'=>'small', // null, 'large', 'small' or 'mini'
    'url' => Yii::app()->createUrl("zone/createWard"),
)); ?>