...
<div class="widget">
    ...
    $this->widget('bootstrap.widgets.TbGridView', array(
        ...
        'summaryText' => 'Tất cả Thành phố - Tỉnh Thành. Hiển thị từ {start}-{end} của {count} kết quả.',
        'columns' => array(
            array('name' => 'id_city', 'header' => 'MV-KV'),
            ...
            array(
                    ...
                    'buttons' => array
                        ...
                        'show' => array
                            ...
                            'label' => 'Xem chi tiết',
                            'icon' => 'icon-eye-open',
                            'url' => 'Yii::app()->createUrl("zone/viewCity", array("id"=>$data["id_city"]))',
                            'options' => array(
                                'class' => 'view',
                            ),
                        ),
                        'modify' => array
                            ...
                            'label' => 'Cập nhật',
                            'icon' => 'icon-document',
                            'url' => 'Yii::app()->createUrl("zone/updateCity", array("id"=>$data["id_city"]))',
                            'options' => array(
                                'class' => 'view',
                            ),
                            'encodeLabel' => false,
                        ...
                        'del' => array(
                            'label' => 'Xóa',
                            'icon' => 'icon-trash',
                            'url' => 'Yii::app()->createUrl("zone/deleteCity", array("id"=>$data["id_city"]))',
                            'click' => "function() {
...
<?php $this->widget('bootstrap.widgets.TbButton', array(
 ...
 <?php $this->widget('bootstrap.widgets.TbButton', array(
    ...
    'type'=>'primary', // null, 'primary', 'info', 'success', 'warning', 'danger' or 'inverse'
    'size'=>'small', // null, 'large', 'small' or 'mini'
    'url' => Yii::app()->createUrl("zone/createCity", array('id'=>  Country::CODE_VIETNAM)),
)); ?>