...
<?php echo $form->errorSummary($model); ?>
	...
	<?php echo $form->textFieldRow($model,'password_strategy',array('class'=>'span5','maxlength'=>128)); ?>

	<?php echo $form->textFieldRow($model,'password_expiry_date',array('class'=>'span5')); ?>
