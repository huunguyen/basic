<?php
if (isset($drange) && is_array($drange)) {
    ...
    foreach ($model->tblZones as $zone) {
        ...
        <fieldset>
            ...
            <?php echo $form->textFieldRow($drange[$counter], "[$counter]delimiter1", array('class' => 'span5', 'maxlength' => 20)); ?>

            <?php echo $form->textFieldRow($drange[$counter], "[$counter]delimiter2", array('class' => 'span5', 'maxlength' => 20)); ?>
...
<script>
    function reloadForm(data) {
        $.fn.yiiactiveform.update('distant-form');
        console.log(data);
    }
</script> 