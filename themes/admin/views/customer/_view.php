<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('id_default_group')); ?>:</b>
	<?php echo CHtml::encode($data->id_default_group); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('id_risk')); ?>:</b>
	<?php echo CHtml::encode($data->id_risk); ?>
	<br />
