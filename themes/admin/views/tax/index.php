...
<div class="grid12">
    ...
    $this->widget('bootstrap.widgets.TbGridView', array(
        ...
        'columns' => array(
            array('name' => 'id_tax', 'header' => 'Mã Thuế'),
            array('name' => 'name', 'header' => 'Loại Thuế'),
             array(
                        'name'=>'description', 
                        'header'=>'Mô tả',
                        'type'=>'html'
            ...
            array(
                    ...
                    'buttons' => array
                        ...
                        'show' => array
                            ...
                            'label' => 'Xem chi tiết',
                            'icon' => 'icon-eye-open',
                            'url' => 'Yii::app()->createUrl("tax/view", array("id"=>$data["id_tax"]))',
                            'options' => array(
                                'class' => 'view',
                            ),
                        ),
                        'modify' => array
                            ...
                            'label' => 'Cập nhật NCC',
                            'icon' => 'icon-document',
                            'url' => 'Yii::app()->createUrl("tax/update", array("id"=>$data["id_tax"]))',
                            'options' => array(
                                'class' => 'view',
                            ),
                            'encodeLabel' => false,
                        ...
                        'del' => array(
                            'label' => 'Xóa NCC',
                            'icon' => 'icon-trash',
                            'url' => 'Yii::app()->createUrl("tax/delete", array("id"=>$data["id_tax"]))',
                            'click' => "function() {
