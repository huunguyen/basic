 <!-- BEGIN STYLE CUSTOMIZER -->
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-shop-info">
                    <ul class="list-unstyled list-inline">
                        <li><i class="fa fa-phone"></i><span>+84 938008404</span></li>
                        <li><i class="fa fa-envelope-o"></i><span>nguyenhuunguyen@gmail.com</span></li>
                    </ul>
                </div>
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        <li><a href="http://localhost/simple_cms/admin" target="quantri">Quản trị</a></li>
                    </ul>
                </div>
                <!-- END TOP BAR MENU -->
            </div>
    ...
    <div class="header">
      <div class="container">
        <a class="site-logo" href="<?=Yii::app()->createUrl("site/shop",array("theme"=>'frontend'))?>"><img src="<?=$this->assetsBase?>/frontend/layout/img/logos/logo-corp-red.png" alt="Metronic FrontEnd"></a>
