...
?>
<div id="content">
    <div id="title">CÓ <?php echo $count; ?> CÂU HỎI </div>
    <div class="clear"></div>
    <div id = 'ajaxRowQuestion'>
        <?php foreach ($data as $value): ?>
            <div class="pricedn" style="margin-bottom : 5px;float: left;border-bottom:1px solid #EBEBEB">
                ...
                <div>
                    <h4 style="color: #333;margin: 0px 0px 10px;font-size: 24px"><a id="news" style="color: #333" href="<?= Yii::app()->createUrl("post/viewQuestion", array('id' => $value->id_post)) ?>"><?php echo $value->title; ?></a></h4>
...
<div class="clear"></div>
<div id='ajaxPageQuestion' style="margin: auto;text-align: center;" align="center">
    <?php
...
<script>
    jQuery("body").delegate("#pages_Question a", "click", function() {
        var qUrl = jQuery(this).attr("href");

        jQuery.get(qUrl, function(data) {
            jQuery('#ajaxRowQuestion').html($(data).find('#ajaxRowQuestion').html());
            jQuery('#ajaxPageQuestion').html($(data).find('#ajaxPageQuestion').html());
        });
