...
<div id="content">
    ...
    <div style="float: left;position: relative;margin-right: 20px;margin-bottom : 10px">
        ...
        <div>
            <h4 style="color: #333;margin: 0px 0px 10px;font-size: 24px"><a id="news" style="color: #333" href="<?=Yii::app()->createUrl("shopping/view",array('id'=>$value->id_post))?>"><?php echo $value->title; ?></a></h4>
