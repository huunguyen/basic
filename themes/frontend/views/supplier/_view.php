<div id="title"> SẢN PHẨM MỚI CỦA <?php echo $model->name; ?> </div>
<div id = 'ajaxRowsup'>
    <?php $i = 1; ?>
...
<div style="text-align:center;margin-bottom: 10px;float: left;width: 100%">
    <div id='ajaxPagesup' style="margin: auto;text-align: center;" align="center">
        <?php
...
<script>
    jQuery("body").delegate("#page_sup a", "click", function() {
        var qUrl = jQuery(this).attr("href");

        jQuery.get(qUrl, function(data) {
            jQuery('#ajaxRowsup').html($(data).find('#ajaxRowsup').html());
            jQuery('#ajaxPagesup').html($(data).find('#ajaxPagesup').html());
        });
