<div id="title"> DANH SÁCH SẢN PHẨM <?php echo $model->name; ?> </div>
<div id = 'ajaxRowcate'>
    <?php $i = 1; ?>
            ...
            <div id="products_r">
                <div id="content2_k">
                    ...
                    <ul style="padding-left:10px;">
                        ...
                        <li>Name: <?php echo StringHelper::Limit($value->name, 25); ?></li>
...
<div style="text-align:center;margin-bottom: 10px;float: left;width: 100%">
    <div id='ajaxPagecate' style="margin: auto;text-align: center;" align="center">
        <?php
...
<script>
    jQuery("body").delegate("#page_catecate a", "click", function() {
        var qUrl = jQuery(this).attr("href");

        jQuery.get(qUrl, function(data) {
            jQuery('#ajaxRowcate').html($(data).find('#ajaxRowcate').html());
            jQuery('#ajaxPagecate').html($(data).find('#ajaxPagecate').html());
        });
